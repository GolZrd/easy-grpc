...
//go:generate minimock -i github.com/GolZrd/easy-grpc/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/GolZrd/easy-grpc/internal/client/db"
